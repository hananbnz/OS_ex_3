...
class WordSearch: public virtual v1Base
{
public:
    /**
     * A default FileNameKey constructor.
 ...
 * @return
 */
bool operator<(const FileNameKey &other) const //TODO Does this fileNameKey change
// works???
{
//    FileNameKey* cur_file_name = this->get_file_name();
